...
class Tcc(models.Model):
    ...
    banca1_tcc = models.ForeignKey(Professor, related_name='Bancaexaminadora', on_delete=models.CASCADE)
    banca2_tcc = models.ForeignKey(Professor, related_name='Bancae_xaminadora', on_delete=models.CASCADE)
    ...
    def __str__(self):
        return self.tema_tcc + " - " + self.id_aluno_tcc
    

class AppTcc(models.Model):
    id_apptcc = models.AutoField(verbose_name="Identificador Apresentacao", primary_key=True)
    id_tcc_apptcc = models.ForeignKey(Tcc, related_name='TemaApresentacao', on_delete=models.CASCADE)
    id_sala_apptcc = models.ForeignKey(Sala, related_name='SaladaApresentacao', on_delete=models.CASCADE)
    dt_apptcc = models.DateTimeField(verbose_name="Data e Hora da Apresentacao", auto_now=False, auto_now_add=False)
    def __str__(self):
        return self.id_sala_apptcc + " - " + self.dt_apptcc